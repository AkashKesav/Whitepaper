...
> 📖 **New Agent?** See [AGENT_INSTRUCTIONS.md](./AGENT_INSTRUCTIONS.md) for development context and continuation guide.
...
- **AI Services API**: http://localhost:8001
- **Memory Kernel Debug**: http://localhost:9000
- **DGraph UI**: http://localhost:8080
...
```env
# LLM Providers
NVIDIA_API_KEY=nvapi-...   # For NVIDIA DeepSeek model
