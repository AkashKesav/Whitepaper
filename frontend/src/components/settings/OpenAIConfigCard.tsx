...
import { Bot, Eye, EyeOff, CheckCircle, XCircle, Loader2, Trash2 } from 'lucide-react';
...
export const OpenAIConfigCard: React.FC<OpenAIConfigProps> = ({
  apiKey,
  hasKey,
  onSave,
  onDelete,
    ...
    <div className="bg-white/5 rounded-xl p-5 border border-white/10">
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-white/50 text-sm">GPT-4, GPT-3.5, Embeddings</p>
          </div>
        </div>
        <div className={cn(
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-white/40 text-xs mt-1.5">
            Get your API key from <a href="https://platform.openai.com/api-keys" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">platform.openai.com</a>
          </p>
        </div>
      ...
      <div className="mt-5 pt-4 border-t border-white/10">
        ...
        <ul className="text-white/50 text-xs space-y-1">
          <li>• gpt-4o (Chat - Recommended)</li>
          <li>• gpt-4o-mini (Chat - Fast)</li>
          <li>• gpt-3.5-turbo (Chat - Budget)</li>
