...
import { Sparkles, Eye, EyeOff, CheckCircle, XCircle, Loader2, Trash2 } from 'lucide-react';
...
export const AnthropicConfigCard: React.FC<AnthropicConfigProps> = ({
  apiKey,
  hasKey,
  onSave,
  onDelete,
    ...
    <div className="bg-white/5 rounded-xl p-5 border border-white/10">
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-white font-medium">Anthropic</h3>
            <p className="text-white/50 text-sm">Claude 3.5, Claude 3</p>
          </div>
        </div>
        <div className={cn(
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-white/40 text-xs mt-1.5">
            Get your API key from <a href="https://console.anthropic.com/settings/keys" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">console.anthropic.com</a>
          </p>
        </div>
      ...
      <div className="mt-5 pt-4 border-t border-white/10">
        ...
        <ul className="text-white/50 text-xs space-y-1">
          <li>• claude-3-5-sonnet-20241022 (Chat - Recommended)</li>
          <li>• claude-3-5-haiku-20241022 (Chat - Fast)</li>
          <li>• claude-3-opus-20240229 (Chat - Most capable)</li>
        </ul>
      </div>
    </div>
  );
