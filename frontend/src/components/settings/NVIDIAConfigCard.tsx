...
import { Cpu, Eye, EyeOff, CheckCircle, XCircle, Loader2, Trash2 } from 'lucide-react';
import { cn } from '@/lib/utils';

interface NVIDIAConfigProps {
  apiKey: string;
  hasKey: boolean;
...
export const NVIDIAConfigCard: React.FC<NVIDIAConfigProps> = ({
  apiKey,
  hasKey,
  onSave,
  onDelete,
    ...
    <div className="bg-white/5 rounded-xl p-5 border border-white/10">
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-white font-medium">NVIDIA NIM</h3>
            <p className="text-white/50 text-sm">AI Model Provider</p>
          </div>
        </div>
        <div className={cn(
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              <input
                ...
                placeholder={hasKey ? "Enter new key to update..." : "nvapi-..."}
                className={cn(
          ...
          <p className="text-white/40 text-xs mt-1.5">
            Get your API key from <a href="https://build.nvidia.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">build.nvidia.com</a>
          </p>
        </div>
      ...
      <div className="mt-5 pt-4 border-t border-white/10">
        ...
        <ul className="text-white/50 text-xs space-y-1">
          <li>• meta/llama-3.1-405b-instruct (Chat)</li>
          <li>• meta/llama-3.1-70b-instruct (Chat)</li>
          <li>• nvidia/nv-embedqa-mistral-7b (Embeddings)</li>
        </ul>
      </div>
    </div>
  );
...
export default NVIDIAConfigCard;
